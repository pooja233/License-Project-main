...
namespace LicensePortal_APPAPI.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        //APi to get only desired user
        //[HttpGet]
        //[Route("Particularuser/{id}")]

        //public IEnumerable<User> GetParticularuser(int id)
        //{
        //    var result1 = _context.Users.Where(auth=> auth.UserId == id).ToList();
        //    return result1;
        //}
