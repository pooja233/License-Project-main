...
{ comments ? <p style={{color:"red",fontSize:".7em"}}>Invalid Email Address or Password</p>: null }
                         <form onSubmit={handleSubmit} noValidate>

                        <div className="row px-3"> <label className="mb-1">
                                <h6 className="mb-0 text-sm">Email Address</h6>
                            </label> <input autoComplete="off" className={`input ${errors.email && 'is-danger'}`} type="email" name="email" onChange={handleChange} value={values.email || ''} required placeholder="Enter a valid email address"></input>{errors.email && (
                    <p style={{color:"red",fontSize:".7em"}}>{errors.email}</p>
                  )}</div>
                        <div className="row px-3"> <label className="mb-1">
                                <h6 className="mb-0 text-sm">Password</h6>
                            </label> <input className={`input ${errors.password && 'is-danger'}`} type="password" name="password" onChange={handleChange} value={values.password || ''} required placeholder="Enter password"></input>{errors.password && (
